...
#Please feel free to leave it better than you found it!
...
#msend -n @bmcPatrolTarget:port#mc -a EVENT –r severity -m message -b "mc_host=host; mc_tool_class=SPLUNK-ENTERPRISE; mc_object=$source; mc_object_owner=$team; mc_tool=$splunksearch; mc_tool_uri=$UriOfSplunkReportIfAvailableORESULTS"
