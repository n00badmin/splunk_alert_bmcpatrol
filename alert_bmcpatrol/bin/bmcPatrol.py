...
def main():
    ...
    msendcmd = 'msend -n @{0}#mc -a EVENT –r {1} -m {2} -b "mc_host={3}; mc_tool_class=SPLUNK-ENTERPRISE; mc_object={4}; mc_object_owner={5}; mc_tool={6}; mc_tool_uri={6}"'
    msendcmd = msendcmd.format(bmcPatrolTargetURI, severity, message, host, source, team, splunkSearch)
    try:
